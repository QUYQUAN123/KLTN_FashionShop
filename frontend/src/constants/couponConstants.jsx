...
export const GET_COUPONS_ON_SHOP_REQUEST = 'GET_COUPONS_ON_SHOP_REQUEST';
export const GET_COUPONS_ON_SHOP_SUCCESS = 'GET_COUPONS_ON_SHOP_SUCCESS';
export const GET_COUPONS_ON_SHOP_FAIL = 'GET_COUPONS_ON_SHOP_FAIL'; 
export const GET_COUPONS_BY_SHOPID = 'GET_COUPONS_BY_SHOPID';
